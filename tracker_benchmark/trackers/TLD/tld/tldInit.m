...
tld.img     = cell(1,tld.nFrames);
tld.snapshot= cell(1,tld.nFrames);
tld.dt      = cell(1,tld.nFrames);
tld.bb      = nan(4,tld.nFrames);
tld.conf    = nan(1,tld.nFrames);
tld.valid   = nan(1,tld.nFrames);
tld.size    = nan(1,tld.nFrames);
tld.trackerfailure = nan(1,tld.nFrames);
tld.draw    = zeros(2,0);
tld.pts     = zeros(2,0);
% Fill first fields
...
tld.X       = cell(1,tld.nFrames); % training data for fern
tld.Y       = cell(1,tld.nFrames); 
tld.pEx     = cell(1,tld.nFrames); % training data for NN
tld.nEx     = cell(1,tld.nFrames);
